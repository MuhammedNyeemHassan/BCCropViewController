...
@protocol CRRulerControlDelegate
-(void) scrollEnded;
@end
...
IB_DESIGNABLE
@interface NCCRRulerControl : UIControl 
...
@property (weak, nonatomic) id<CRRulerControlDelegate>delegate;
/**
 ...
 *  Change size of line mark
 *
 *  @param color Color of line Mark default used tintColor of CRRulerControl
 *  @param markType  NS_OPTIONS CRRulerMarkType. 
 ...
 *
 *  @param textColor Color of line Mark default used tintColor of CRRulerControl
 *  @param markType  NS_OPTIONS CRRulerMarkType.
 *                   CRRulerMarkTypeMajor for choose Major Mark
 *                   CRRulerMarkTypeMiddle for choose Middle Mark
 *                   CRRulerMarkTypeMinor for choose Minor Mark
 ...
 *
 *  @param font  Font of text mark default Courier with size 10
 *  @param markType  NS_OPTIONS CRRulerMarkType.
 *                   CRRulerMarkTypeMajor for choose Major Mark
 *                   CRRulerMarkTypeMiddle for choose Middle Mark
 *                   CRRulerMarkTypeMinor for choose Minor Mark
