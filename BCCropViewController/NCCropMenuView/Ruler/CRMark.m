...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.color = [UIColor clearColor];                      // default color set in RullerControl (is Tint Color)
        self.font = [UIFont systemFontOfSize:0 weight:UIFontWeightMedium]; // default font for all text mark
        self.textColor = [UIColor clearColor];                  // default color set in RullerControl (is Tint Color)
